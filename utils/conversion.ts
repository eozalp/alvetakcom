...
import { RingSizeEntry, InputType, SizeSystemKeys } from '../types';
import { ringSizeData } from '../data/ringSizes';
...
export const findMatchingSize = (
  ...
  if (inputType === InputType.DIAMETER_MM || inputType === InputType.CIRCUMFERENCE_MM) {
    ...
    let closestMatch: RingSizeEntry | null = null;
...
export const getAvailableOptionsForInputType = (inputType: InputType): string[] => {
